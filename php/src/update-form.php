...
<head>
    ...
    <link rel="stylesheet" href="./style/updatebody.css">
...
?>
    <div class="container">          
    <img src="https://static.vecteezy.com/system/resources/previews/003/073/624/original/work-employees-in-the-office-labor-collective-secretary-and-boss-vector.jpg">

        <form class="form" action="" method="post" enctype="multipart/form-data">
        <h3>INSERT NEW BOOKS</h3>
                <label for="name">BOOKNAME</label>
                <input type="text" class="text" name="name" value="<?php echo $row['name']; ?>" required>
                <br>
                <label for="author">AUTHORNAME</label>
                <input type="text" class="text" name="author"  value="<?php echo $row['author']; ?>" required>
            <div class="preimage">
