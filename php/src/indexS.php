                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="dd">
                                        ...
                                        <td> <a href="update-form.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
